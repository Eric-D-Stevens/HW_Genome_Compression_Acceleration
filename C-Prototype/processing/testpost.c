...
file_size = (double)fsize("name.tst");
file_size = file_size + (double)fsize("qual.tst");
file_size = file_size + (double)fsize("gene.tst");

char command[50];

printf("\n\n\nRecombining Files.........\n\n");
strcpy(command, "./fpost");
...
//////////////////////////////////////////////////
	...
	strcpy(command, "diff -s output.fastq ../test.fastq");
